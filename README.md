...
We consider the simulation study of generating `n_simu` of a sample of size `sample_size` of $X_i$ where $X\sim \mathcal{N}(0,1)$ and computing the mle estimator of the mean 
